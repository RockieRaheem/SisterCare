-- Atomically claim an available counsellor while matching a queued session.
-- The function is server-only and prevents two concurrent queue drainers from
-- assigning the same counsellor.
