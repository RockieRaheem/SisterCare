...
export const CLINICAL_CONTENT_REGISTRY: ClinicalContentGovernance[] = [
  ...
  },
  {
    ...
    riskLevel: "critical",
    country: "UG",
    languages: ["eng", "lug", "ach", "lgg", "nyn", "teo", "swa"],
  ...
  {
    id: "risk.medical-output-firewall",
    kind: "risk_rule",
    version: "1.0.0",
    riskLevel: "critical",
    country: "UG",
    ...
    evidenceSources: ARTICLE_EVIDENCE,
    reviewStatus: "requires_clinical_review",
    changeSummary: "Post-generation diagnosis, prescription and dose blocker with multilingual adversarial corpus",
  },
];
