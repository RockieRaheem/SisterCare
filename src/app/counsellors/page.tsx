...
const mockCounsellors: Counsellor[] = [
  {
    ...
    specializations: ["Mental Health", "Reproductive Health", "Pregnancy & Postpartum"],
    ...
    availableHours: { start: "08:00", end: "18:00", days: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"] },
    sessionCount: 1240,
    verified: true,
  ...
  },
  {
    ...
    specializations: ["Menstrual Health", "Reproductive Health", "Sexual Health"],
    ...
    availableHours: { start: "09:00", end: "17:00", days: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"] },
    sessionCount: 856,
    verified: true,
  ...
  },
  {
    ...
    specializations: ["Nutrition & Wellness", "Menstrual Health", "Adolescent Health"],
    photoURL: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=400&h=400&fit=crop&crop=face",
    status: "available",
    rating: 4.7,
    reviewCount: 76,
    yearsExperience: 6,
    ...
    whatsappNumber: "+256702345678",
    availableHours: { start: "10:00", end: "19:00", days: ["Monday", "Wednesday", "Friday", "Saturday"] },
    sessionCount: 543,
    verified: true,
  ...
  },
  {
    ...
    whatsappNumber: "+256703456789",
    availableHours: { start: "08:00", end: "16:00", days: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"] },
    sessionCount: 672,
    verified: true,
  ...
  },
  {
    ...
    whatsappNumber: "+256704567890",
    availableHours: { start: "07:00", end: "15:00", days: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"] },
    sessionCount: 1890,
    verified: true,
  ...
  },
  {
    ...
    specializations: ["Relationship Counselling", "Mental Health", "Sexual Health"],
    ...
    whatsappNumber: "+256705678901",
    availableHours: { start: "11:00", end: "20:00", days: ["Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"] },
    sessionCount: 398,
    verified: false,
...
export default function CounsellorsPage() {
  ...
  const [selectedSpecialty, setSelectedSpecialty] = useState<CounsellorSpecialty | "all">("all");
  const [selectedStatus, setSelectedStatus] = useState<CounsellorStatus | "all">("all");
  ...
  const filteredCounsellors = useMemo(() => {
    ...
    if (selectedSpecialty !== "all") {
      result = result.filter((c) => c.specializations.includes(selectedSpecialty));
    }
  ...
  const handleWhatsAppClick = (counsellor: Counsellor) => {
    ...
    window.open(`https://wa.me/${counsellor.whatsappNumber.replace("+", "")}?text=${message}`, "_blank");
  };
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 pb-24">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary via-purple-600 to-pink-500 p-8 mb-8 text-white">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 max-w-2xl mb-6">
              Connect with our verified health professionals for personalized guidance and support. 
            ...
            <div className="flex flex-wrap gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold">{availableCount} Available Now</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined">verified</span>
                <span>{counsellors.filter(c => c.verified).length} Verified Professionals</span>
              </div>
              <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="hidden lg:flex gap-3">
              ...
              <select
                ...
                onChange={(e) => setSelectedStatus(e.target.value as CounsellorStatus | "all")}
              ...
              <select
                ...
                onChange={(e) => setSelectedSpecialty(e.target.value as CounsellorSpecialty | "all")}
                className="px-4 py-3 rounded-xl bg-bg-light dark:bg-bg-dark border border-border-light dark:border-border-dark text-text-primary dark:text-white focus:outline-none focus:ring-2 focus:ring-primary"
              >
              ...
              <select
                value={sortBy}
                onChange={(e) => setSortBy(e.target.value as "rating" | "experience" | "sessions")}
                className="px-4 py-3 rounded-xl bg-bg-light dark:bg-bg-dark border border-border-light dark:border-border-dark text-text-primary dark:text-white focus:outline-none focus:ring-2 focus:ring-primary"
              >
        ...
        <div className="flex items-center justify-between mb-6">
          <p className="text-text-secondary">
            Showing <span className="font-semibold text-text-primary dark:text-white">{filteredCounsellors.length}</span> counsellor{filteredCounsellors.length !== 1 ? "s" : ""}
          </p>
          {(selectedSpecialty !== "all" || selectedStatus !== "all" || searchQuery) && (
            <button
              onClick={() => {
                setSearchQuery("");
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-text-secondary text-sm">
                If you&apos;re in crisis or need emergency support, please contact emergency services or a crisis hotline immediately.
              </p>
            </div>
            <a
              href="tel:116"
        ...
        <div className="mt-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-border-light dark:border-border-dark">
              ...
              <p className="text-text-secondary text-sm">
                Yes, all conversations with our counsellors are 100% confidential. Your privacy is our top priority.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-border-light dark:border-border-dark">
              ...
              <p className="text-text-secondary text-sm">
                Each counsellor card shows their current status: Available (green), In Session (amber), or Offline (gray). You can only contact counsellors who are currently available.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-5 border border-border-light dark:border-border-dark">
              ...
              <p className="text-text-secondary text-sm">
                Verified counsellors have had their professional credentials, qualifications, and identity verified by our team.
              </p>
            </div>
          </div>
        </div>
