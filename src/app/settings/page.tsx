            ...
            <div className="flex flex-col gap-3">
              <div className="flex justify-between items-center">
                ...
                <select
                  ...
                  className="px-4 py-2 rounded-lg border border-primary/20 bg-background-light dark:bg-background-dark text-text-primary dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/20"
                >
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <p className="text-text-primary dark:text-white text-base font-bold flex items-center gap-2">
              ...
              {browserNotificationStatus === "unsupported" ? (
                ...
                <div className="p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800/40">
