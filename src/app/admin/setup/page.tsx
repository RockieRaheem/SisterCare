...
export default function AdminSetupPage() {
  ...
  const activate = async (event: FormEvent) => {
    ...
    try {
      ...
      if (!token) throw new Error("Sign in with the account you want to make an administrator.");
      ...
      if (!response.ok) throw new Error(result.error || "Administrator activation failed");
