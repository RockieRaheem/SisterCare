...
export default function AdminDashboardPage() {
  ...
  if (checking) return <Shell><div className="py-20 text-center"><p className="text-gray-500 dark:text-gray-400">Verifying secure workspace…</p>{verificationUnavailable && <button onClick={() => void retry()} className="mt-4 rounded-xl border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-800 dark:border-gray-600 dark:bg-card-dark dark:text-white">Retry verification</button>}</div></Shell>;
